...
export const apiEndpoints = {
  ...
  profiles: {
    ...
    uploadPhoto: "/api/v1/profiles/photos",
    deletePhoto: (id: string) => `/api/v1/profiles/photos/${id}`,
    setPrimaryPhoto: (id: string) => `/api/v1/profiles/photos/${id}/primary`,
  },
  matches: {
    base: "/api/v1/matches",
    daily: "/api/v1/matches/daily",
    recommendations: "/api/v1/matches/recommendations",
  },
  interests: {
    send: "/api/v1/interests/send",
  ...
  messages: {
    ...
    conversation: (id: string) => `/api/v1/messages/conversations/${id}`,
  ...
  subscriptions: {
    ...
    createOrder: "/api/v1/subscriptions/create-order",
    verifyPayment: "/api/v1/subscriptions/verify-payment",
  },
  users: {
    base: "/api/v1/users",
  ...
  admin: {
    ...
    approveUser: (id: string) => `/api/v1/admin/users/${id}/approve`,
